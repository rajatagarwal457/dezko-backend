...
class BeatSyncEngine:
    ...
    def render(self, assets_dir, output_file):
        ...
        try:
            ...
            call = f"ffmpeg -i {os.path.join(self.project_dir, 'Vireo.mp4')} -c copy -bsf:v h264_mp4toannexb {os.path.join(self.project_dir, 'temp_dir', 'vireo.ts')}"
